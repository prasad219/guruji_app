...
public class weddingfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_weddingfragment, container, false);
        //Destinationwed = (Button) view.findViewById(R.id.destinationwed);
      //  Premiumwed = (Button) view.findViewById(R.id.premiumwed);
     //   Standardwed = (Button) view.findViewById(R.id.standardwed);


        RelativeLayout destibanner = view.findViewById(R.id.destinationbanner);
        destibanner.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        RelativeLayout prembanner = view.findViewById(R.id.premiumbanner);
        prembanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), weddinglist.class);
                Log.e("Cardview","CLICK");
        ...
        RelativeLayout standbanner = view.findViewById(R.id.standardbanner);
        standbanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), weddinglist.class);
                Log.e("Cardview","CLICK");
